    ...
    }),
    {
      ...
      openPositions: fields.object({
        ...
        jobs: fields.array(
          ...
          { label: 'Postes', itemLabel: props => props.fields.jobTitle.value || 'Poste' },
        ),
      ...
      forfaitHome: fields.object({
        ...
        tagsTitle: fields.text({ label: 'Titre du bandeau de tags' }),
        tags: fields.array(fields.text({ label: 'Tag' }), { label: 'Tags', itemLabel: props => props.value || 'Tag' }),
        explainerTitle: fields.text({ label: 'Titre bloc explicatif' }),
        explainerText: fields.text({ label: 'Texte bloc explicatif', multiline: true }),
